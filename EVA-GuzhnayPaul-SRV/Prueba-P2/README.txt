...
a persistence unit "Prueba-P2PersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/Prueba_P2/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "Prueba-P2/pom.xml":
...
artifact ("Prueba-P2.war") is already built. You can build
